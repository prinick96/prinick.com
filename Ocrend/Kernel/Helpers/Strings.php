...
final class Strings extends \Twig_Extension {
  ...
  */
  ...
  //------------------------------------------------
  /**
    * Da formato a la descripción del video
    *
    * @param string $txt: Descripción del video
    *
    * @return string descripción
  */
  final public static function description_video(string $txt) : string {
    # Acomodamos
    $txt = trim($txt);
    $txt = html_entity_decode($txt);
    
    # Encontrar coincidencias de URL y convertirlas en URL reales
    $txt = preg_replace("/((http|https|www)[^\s]+)/", '<a href="$1">$0</a>', $txt);
    $txt = preg_replace("/href=\"www/", 'href="http://www', $txt);   
  ...
  */
  public function getFunctions() : array {
    return array(
      ...
      new \Twig_Function('description_video', array($this, 'description_video'))
    );
  }
  //------------------------------------------------
  /**
